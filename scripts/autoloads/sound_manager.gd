...
func _ready():
	...
	sfx_sounds["damage_1"] = load("res://assets/audio/sfx/characters/damage_1.ogg")
	sfx_sounds["heal"] = load("res://assets/audio/sfx/characters/heal.ogg")
	sfx_sounds["click_1"] = load("res://assets/audio/sfx/ui/click_1.ogg")
	sfx_sounds["focus_1"] = load("res://assets/audio/sfx/ui/focus_1.ogg")
	sfx_sounds["skip_1"] = load("res://assets/audio/sfx/ui/skip_1.ogg")
